    ...
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="col-md-4 text-right">
                <a href="./create_seminar_hall.php" class="btn btn-success font-weight-bold">Create Seminar Hall</a>
            </div>
        </div>
        <div class="mt-4">
            <?php
            ...
            ?>
                <div class="text-center">
                    ...
                    <small class="text-danger font-weight-bold">Create seminar halls to display over here.</small>
                </div>
            <?php
            } else {
            ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><p class="m-0" title="<?php echo $row[2]; ?>"><?php echo $row[2]; ?></p></td>
                                <td><a href="./update_seminar_hall.php?id=<?php echo $row[0]; ?>" class="badge badge-success">Edit</a></td>
                                <td><a href="./seminar_hall.php?id=<?php echo $row[0]; ?>" class="badge badge-danger">Delete</a></td>
                            </tr>
                        <?php
                        }
                        ?>
...
if (isset($_GET['id'])) {
    $delete_query = "DELETE FROM `seminar_halls` WHERE `seminar_halls`.`id` = $_GET[id]";
    if (mysqli_query($con, $delete_query)) {
?>
        <script>
            alert('Seminar Hall has been deleted successfully!');
